...
export const designTestObject_preCalc: TotalsCalculatorInputType = {
    ...
    delivery: {
        ...
        recipient: {
            postalAddress: {
                country: COUNTRY_ID_CODES.UNITED_STATES_OF_AMERICA
            }
        }
    },
    paymentInformation: {
        ...
        taxExemptionReason: [
            {
                ...
                reason: 'Keine Umsatzsteuer auf Grund von Kleinunternehmerregelung'
            }
        ],
    ...
    invoiceLines: [
        {
            ...
            productPriceAgreement: {
                ...
                productPricing: {
                    basisPricePerItem: 20.0,
                    priceBaseQuantity: { quantity: 1, unit: 'KGM' as UNIT_CODES },
                    priceAllowancesAndCharges: { allowances: [{ actualAmount: 1.0 }] }
                }
            },
        ...
        },
        {
            ...
            productPriceAgreement: {
                productPricing: {
                    basisPricePerItem: 90
                }
            },
            delivery: { itemQuantity: { quantity: 1, unit: 'KGM' as UNIT_CODES } },
            settlement: {
                tax: {
                    categoryCode: TAX_CATEGORY_CODES.EXEMPT_FROM_TAX
                }
        ...
        },
        {
            ...
            delivery: { itemQuantity: { quantity: 3, unit: 'KGM' as UNIT_CODES } },
            settlement: {
                tax: {
        ...
        {
            generalLineData: { lineId: '6' },
            productDescription: {
                name: 'Intra-Community Supply Item'
            },
            productPriceAgreement: {
                productPricing: {
                    basisPricePerItem: 21
                }
            },
            delivery: { itemQuantity: { quantity: 4, unit: 'KGM' as UNIT_CODES } },
            settlement: {
                tax: {
        ...
        {
            generalLineData: { lineId: '7' },
            productDescription: {
                name: 'Export Supply Item'
            },
            productPriceAgreement: {
                productPricing: {
                    basisPricePerItem: 9
        ...
        {
            generalLineData: { lineId: '9' },
            productDescription: {
                name: 'IGIC Item'
            },
            productPriceAgreement: {
                productPricing: {
                    basisPricePerItem: 3.545
                }
            },
            delivery: {
                itemQuantity: {
        ...
        },
        {
            ...
            settlement: {
                tax: {
                    categoryCode: TAX_CATEGORY_CODES.ZERO_RATED_GOODS
                }
            }
        }
    ]
