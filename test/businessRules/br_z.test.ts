...
describe('BR-Z', () => {
    ...
    describe('BR-Z-2', () => {
        ...
        test('BR-Z-2 positive test: Seller local tax id available', async () => {
            const data: ComfortProfile = {
                ...zeroRatedInvoice,
                seller: { ...zeroRatedInvoice.seller, taxIdentification: { localTaxId: '345 612 3' } },
                totals: {
                    ...zeroRatedInvoice.totals,
        ...
        test('BR-Z-2 positive test: Seller tax representative VAT id available', async () => {
            const data: ComfortProfile = {
                ...zeroRatedInvoice,
                seller: { ...zeroRatedInvoice.seller, taxIdentification: undefined },
    ...
    describe('BR-Z-3', () => {
        ...
        test('BR-Z-3 positive test: Seller local tax id available', async () => {
            const data: ComfortProfile = {
                ...
                totals: {
                    ...zeroRatedInvoice.totals,
                    taxBreakdown: [{ ...zeroRatedInvoice.totals.taxBreakdown[0], basisAmount: 9 }],
                    documentLevelAllowancesAndCharges: {
                        ...zeroRatedInvoice.totals.documentLevelAllowancesAndCharges,
                        charges: undefined
                    },
    ...
    describe('BR-Z-4', () => {
        ...
        test('BR-Z-4 positive test: Seller local tax id available', async () => {
            const data: ComfortProfile = {
                ...
                totals: {
                    ...zeroRatedInvoice.totals,
                    taxBreakdown: [{ ...zeroRatedInvoice.totals.taxBreakdown[0], basisAmount: 11 }],
                    documentLevelAllowancesAndCharges: {
                        ...zeroRatedInvoice.totals.documentLevelAllowancesAndCharges,
    ...
    describe('BR-Z-5', () => {
        ...
        test('BR-Z-5 negative test: Tax Rate in Line is not 0', async () => {
            const data: ComfortProfile = {
                ...
                invoiceLines: [
                    {
                        ...zeroRatedInvoice.invoiceLines[0],
                        settlement: {
                            tax: {
                                typeCode: 'VAT' as TAX_TYPE_CODE,
